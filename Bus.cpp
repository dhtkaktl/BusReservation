#include<string> // 2019-11-20 수요일 오후 10:30 곽민형
#include<iostream>
...
public:
	...
	void decrease();	// decrease, increase는 없어져야
	void increase();
	int showSeat();	// 좌석배치도 출력
	int getSeatCount() { return seatCount; } // 잔여석 접근
	int getTotalSeats() { return totalSeats; } // 총 좌석 수 접근
